...
export const InfoIcon = (props: WebSvgProps) => {
  ...
  return (
    <svg width={iconSize} height={iconSize} fill="none">
      <path
        fillRule="evenodd"
...
export const SuccessIcon = (props: WebSvgProps) => {
  const iconSize = iconSizing[props.size || 'sm'];
...
export const WarningIcon = (props: WebSvgProps) => {
  const iconSize = iconSizing[props.size || 'sm'];
...
export const DangerIcon = (props: WebSvgProps) => {
  const iconSize = iconSizing[props.size || 'sm'];
